...
(sum(case when type=1 or type=6 or type=7 or type=8 then 1 else 0 end) + sum(case when type=2 then 1 else 0 end)) / ($lastDay - sum(case when type=4 then 1 else 0 end) - sum(case when type=3 then 1 else 0 end)) as active
