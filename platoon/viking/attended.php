...
if ( mysqli_num_rows($results) > 0 ) 
{
    ...
    while($row = mysqli_fetch_assoc($results))
    {
        ...
        if ( $date > $laterDate )
        {
          ...
          {
          $present = 1;
           $nsql1 = "INSERT INTO attendances (platoon,is_present,created_on,user_id,month_day) 
          ...
          {
            $training = 1;
            $nsql2 = "INSERT INTO attendances (platoon,is_training,created_on,user_id) VALUES ('" . $uplatoon . "','" . $training . "','" . $dateString . "','" . $uuid . "')";
...
else
{
  ...
  {
    $present = 1;
    $nsql3 = "INSERT INTO attendances (platoon,is_present,created_on,user_id) VALUES ('" . $uplatoon . "','" . $present . "','" . $dateString . "','" . $uuid . "')";
...
{
  $training = 1;
  $nsql4 = "INSERT INTO attendances (platoon,is_present,created_on,user_id) VALUES ('" . $uplatoon . "','" . $training . "','" . $dateString . "','" . $uuid . "')";
