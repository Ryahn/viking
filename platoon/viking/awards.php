	...
	<div id="page-wrapper">
        ...
        <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Select an award <span class="alert alert-info attend-alert">Only click the X or &#10004; once</span>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="dataTable_wrapper">
                            	<div class="panel-group" id="accordion">
                            		<div class="panel panel-default">
                            			<div class="panel-heading panel-award-heading">
                                        	<h4 class="panel-title">
                                            	<a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Air Team Qualifications</a>
                                        	</h4>
                                    	</div>
                            ...
                            <div class="dataTable_wrapper">
                            	<div class="panel-group" id="accordion">
                            		<div class="panel panel-default">
                            			<div class="panel-heading panel-award-heading">
                                        	<h4 class="panel-title">
                                            	<a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Air Team Medals</a>
                                        	</h4>
                                    	</div>
                            ...
                            <div class="dataTable_wrapper">
                            	<div class="panel-group" id="accordion">
                            		<div class="panel panel-default">
                            			<div class="panel-heading panel-award-heading">
                                        	<h4 class="panel-title">
                                            	<a data-toggle="collapse" data-parent="#accordion" href="#collapseSeven">Weapons Qualifications</a>
                                        	</h4>
                                    	</div>
