...
<tr style="border-bottom: 2px solid rgba(221, 221, 221, 0.38);">                                     
  <th style="border-bottom:0px;" class="center">Rank/Name</th>
    ...
    if ( $row['is_loa'] )
    {
      echo "<tr class='tr-loa' style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /><a style='color:inherit;text-decoration:none;' href='editroster.php?id=" . $row['ruser_id']."'> " .$row['rname'] . "</a> <span class='label label-default label-loa'>LOA</span></td>";
    }
    elseif ( $oneweek->format('Y-m-d') >= $inactiveDate )
    {
      echo "<tr class='tr-awol' style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /> <a style='color:inherit;text-decoration:none;' href='editroster.php?id=" . $row['ruser_id']."'> " .$row['rname'] . "</a><span class='label label-danger label-awol'>AWOL</span></td>";
    }
    elseif ( $row['is_rrd'] )
    {
      echo "<tr class='tr-rrd' style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /> <a style='color:inherit;text-decoration:none;' href='editroster.php?id=" . $row['ruser_id']."'> " .$row['rname'] . "</a><span class='label label-rrd'>RRD</span></td>";
    }
    else
    {
    echo "<tr style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /><a style='color:inherit;text-decoration:none;' href='editroster.php?id=" . $row['ruser_id']."'> " .$row['rname'] . "</a></td>";
  }
  }
  else
  {
    if ( $row['is_loa'] )
    {
      echo "<tr class='tr-loa' style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /><a style='color:inherit;text-decoration:none;' href='#'> " .$row['rname'] . "</a> <span class='label label-default label-loa'>LOA</span></td>";
    }
    elseif ( $oneweek->format('Y-m-d') >= $inactiveDate )
    {
      echo "<tr class='tr-awol' style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /> <a style='color:inherit;text-decoration:none;' href='#'> " .$row['rname'] . "</a><span class='label label-danger label-awol'>AWOL</span></td>";
    }
    elseif ( $row['is_rrd'] )
    {
      echo "<tr class='tr-rrd' style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /> <a style='color:inherit;text-decoration:none;' href='#'> " .$row['rname'] . "</a><span class='label label-rrd'>RRD</span></td>";
    }
    else
    {
    echo "<tr style='border-top: 1px solid rgba(221, 221, 221, 0.14);font-size:16px;'><td style='border-top: 0px;'><img style='vertical-align: text-bottom;' height='34px' src='" . $row['base64'] ."' alt='" . $row['name'] . "' /><a style='color:inherit;text-decoration:none;' href='#'> " .$row['rname'] . "</a></td>";
  }
  }
                                        ?>
