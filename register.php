...
$regSql = "INSERT INTO login_users (username, email, password,registered_on, permission, active, activate_code, type, platoon, avatar, last_login, last_active, ip, paypal, banned,sid)
VALUES ('$username1','$email', '$saltedpass', UNIX_TIMESTAMP(NOW()), 3,0,'$activate_code1','admin','$platoon',0,0,0,0,0,0,0)";
