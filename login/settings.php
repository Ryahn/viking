		...
		<div class='col-md-2'>
			...
			<nav>
				<ul class='nav nav-pills nav-stacked span2'>
					...
					<li><a href='?page=login'><span class='glyphicon glyphicon-log-in' aria-hidden='true'></span> <?php echo $m['login_menu']; ?></a></li>
					<li><a href='?page=registration'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span> <?php echo $m['registration_menu']; ?></a></li>
					...
					<li><a href='?page=mails'><span class='glyphicon glyphicon-envelope' aria-hidden='true'></span> <?php echo $m['mails_menu']; ?></a></li>
					<li><a href='?page=links'><span class='glyphicon glyphicon-link' aria-hidden='true'></span> <?php echo $m['links_menu']; ?></a></li>
					<li><a href='?page=messages'><span class='glyphicon glyphicon-comment' aria-hidden='true'></span> <?php echo $m['messages_menu']; ?></a></li>
					<li class='nav-divider'></li>
					<li><a href='?page=social'><span class='glyphicon glyphicon-globe' aria-hidden='true'></span> <?php echo $m['social_menu']; ?></a></li>
					<li><a href='?page=plans'><span class='glyphicon glyphicon-briefcase' aria-hidden='true'></span> <?php echo $m['plans_menu']; ?></a></li>
					<li><a href='?page=coupons'><span class='glyphicon glyphicon-tag' aria-hidden='true'></span> <?php echo $m['coupons_menu']; ?></a></li>
				</ul>
			</nav>
		</div>
			...
			<div class='row row-2'>
				...
				<div class='col-md-6'>
					<div class='panel panel-<?php if(getSetting("enable_paypal", "text") == "true") { echo "success"; } else { echo "danger"; } ?>'>
						<div class='panel-body'>
							<img src='<?php echo $script_path; ?>assets/images/paypal.png' width='100px' height='26px'>
				...
				<div class='col-md-6'>
					<div class='panel panel-<?php if(getSetting("enable_stripe", "text") == "true") { echo "success"; } else { echo "danger"; } ?>'>
						<div class='panel-body'>
							<img src='<?php echo $script_path; ?>assets/images/stripe_logo.png' width='100px' height='34px'>
