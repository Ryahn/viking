		...
		<div class='col-md-2'>
			...
			<nav>
				<ul class='nav nav-pills nav-stacked span2'>
					...
					<li><a href='?page=statistics'><span class='glyphicon glyphicon-stats' aria-hidden='true'></span> <?php echo $m['statistics']; ?></a></li>
					<li><a href='?page=tools'><span class='glyphicon glyphicon-wrench' aria-hidden='true'></span> <?php echo $m['tools']; ?></a></li>
					<li><a href='?page=logs'><span class='glyphicon glyphicon-list-alt' aria-hidden='true'></span> <?php echo $m['logs']; ?></a></li>
					<li><a href='?page=blocked'><span class='glyphicon glyphicon-ban-circle' aria-hidden='true'></span> <?php echo $m['blocked_ip']; ?></a></li>
				</ul>
			</nav>
		</div>
